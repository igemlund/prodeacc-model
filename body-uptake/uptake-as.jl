...
plot()
plot!(sol.t,sol[28,:], ylim = [0,9.9e-5])
plot!(sol.t, sol[38,:], ylim = [0,9.9e-5])
plot!(sol.t, sol[8,:] + sol[18,:], ylim = [0,9.9e-5])
plot!(sol.t, sol[8,:] + sol[18,:] + sol[28,:] + sol[38,:], ylim = [0,9.9e-5])
