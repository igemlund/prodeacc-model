...
k_transport = 2.67e-19              # unknown Based on http://www.tiem.utk.edu/~gross/bioed/webmodules/diffusion.htm
...
bacteria_uptake = @ode_def begin
    ...
    dG =(-k_transport*(G/V_gut-C/V_cell)*N*TP            # Number of ions in gut
        + k_CG * N * C)
    ...
    dC = (k_transport*(G/V_gut-C/V_cell)*TP              # Number of ions in cytoplasm
        - k_CG * C
        - k_CA * C * AP_free
        - k_pro_deg * C)
end a
